...
const ProfilePage = () => {
  ...
  const tabs = [
    ...
    { id: 'notifications', icon: <Bell size={20} />,     label: 'Notifications', badge: 1 },
    { id: 'security',      icon: <ShieldOff size={20} />,label: 'Security'       },
  ]
          ...
          <div className="relative flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-3 mt-4">
                ...
                <span className="px-4 py-1.5 bg-slate-100 text-slate-500 rounded-full text-xs font-bold uppercase tracking-widest">
                  {user.role}
                </span>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4 space-y-4">
            {tabs.map(tab => (
              <button
                ...
                className={`w-full flex items-center justify-between p-5 rounded-3xl font-bold transition-all ${
                  activeTab === tab.id
          ...
          <div className="lg:col-span-8">
            <div className="bg-white rounded-[3rem] p-8 shadow-sm border border-slate-100 min-h-[500px]">
                ...
                <div className="space-y-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <input
                        type="text"
                        className="w-full bg-slate-50 border-none rounded-2xl p-4 focus:outline-none focus:ring-2 focus:ring-indigo-500"
              ...
              {activeTab === 'address' && (
                <div className="space-y-6">
                  ...
                  <div className="p-6 border-2 border-indigo-100 bg-indigo-50/20 rounded-3xl relative">
                    <span className="absolute top-4 right-4 text-[10px] font-black bg-indigo-600 text-white px-2 py-1 rounded-md">
                      DEFAULT
                    </span>
              ...
              {activeTab === 'notifications' && (
                <div className="space-y-4">
                  ...
                  {user.notifications.map((notif, i) => (
                    <div
                      key={i}
                      className={`p-5 rounded-2xl flex items-start gap-4 ${notif.read ? 'bg-slate-50 opacity-60' : 'bg-white border border-slate-100 shadow-sm'}`}
                    >
                      <div className={`w-2 h-2 rounded-full mt-2 ${notif.read ? 'bg-slate-300' : 'bg-indigo-500'}`} />
              ...
              {activeTab === 'security' && (
                <div className="space-y-6">
                  <h2 className="text-xl font-black italic tracking-tighter uppercase">Security.</h2>
                  <div className="space-y-4">
                    <div className="space-y-2">
